    ...
    <div className="container border-top mt-5">
      <div className="row mt-5">
        ...
        <div className="col">
          ...
          <br /><br />
          <a href="" style={{textDecoration:"none"}} className="text-muted">Philosophy</a>
          <br /><br />
        ...
        <div className="col">
          ...
          <br /><br />
          <a href=""style={{textDecoration:"none"}} className="text-muted">How to file a complaint?</a>
          <br /><br />
          <a href=""style={{textDecoration:"none"}} className="text-muted">Status of your complaints</a>
          <br /><br />
          <a href=""style={{textDecoration:"none"}} className="text-muted">Bulletin</a>
          <br /><br />
          <a href=""style={{textDecoration:"none"}} className="text-muted">Circular</a>
          <br /><br />
          <a href=""style={{textDecoration:"none"}} className="text-muted">Z-Connect blog</a>
          <br /><br />
          <a href=""style={{textDecoration:"none"}} className="text-muted">Downloads</a>
          <br /><br />
        </div>
        <div className="col">
          <p>Account</p>
          <a href=""style={{textDecoration:"none"}} className="text-muted">Open demat account</a>
          <br /><br />
          <a href=""style={{textDecoration:"none"}} className="text-muted">Minor demat account</a>
          <br /><br />
          <a href=""style={{textDecoration:"none"}} className="text-muted">NRI demat account</a>
          <br /><br />
          <a href=""style={{textDecoration:"none"}} className="text-muted">Commodity</a>
          <br /><br />
          <a href=""style={{textDecoration:"none"}} className="text-muted">Dematerialisation</a>
          <br /><br />
          <a href=""style={{textDecoration:"none"}} className="text-muted">Fund transfer</a>
          <br /><br />
          <a href=""style={{textDecoration:"none"}} className="text-muted">MTF</a>
          <br /><br />
          <a href=""style={{textDecoration:"none"}} className="text-muted">Referral program</a>
          <br /><br />
        </div>
      </div>
